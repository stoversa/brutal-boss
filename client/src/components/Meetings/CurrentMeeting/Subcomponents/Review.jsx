        ...
        <div>
          ...
          <div className="container-fluid">
            ...
            <div className="row">
              ...
              <div className="col-xl-8 col-md-8 d-none d-sm-block">
            ...
            <div>
              ...
              <div className="rowMargin row">
                <div className="peopleList col-xl-2 col-md-2 text-light bg-secondary">
                ...
                <div className="col-xl-8 col-md-7 bg-white">
                  <div className="row">
                ...
                <br /> mollit anim id est laborum
                  ...
                  <div className="row">
                    <form className="col-12 bg-title">
                      <div className="form-group">
